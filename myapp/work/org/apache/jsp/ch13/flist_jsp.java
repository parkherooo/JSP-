 ...
 * Generated at: 2024-09-06 01:34:25 UTC
...
public final class flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      ch13.FileloadBean bean = null;
      bean = (ch13.FileloadBean) _jspx_page_context.getAttribute("bean", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (bean == null){
        bean = new ch13.FileloadBean();
	...
	Vector<FileloadBean> vlist = mgr.listFile();
      ...
      out.write("		if(f.allCh.checked){ //체크되면 true\r\n");
      out.write("			for(i=0; i<f.fch.length;i++){\r\n");
      out.write("				f.fch[i].checked = true;	\r\n");
      out.write("			}\r\n");
      out.write("			f.btn.disabled = false; //버튼 활성화\r\n");
      ...
      out.write("	   f = document.frm;\r\n");
      out.write("	   for(i=0; i<f.fch.length;i++){\r\n");
      out.write("		   if(f.fch[i].checked){ //체크가 된경우\r\n");
